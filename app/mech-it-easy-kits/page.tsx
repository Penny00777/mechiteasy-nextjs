...
const kitsData = [
  { id: 'hand-crank-generator', name: 'Hand Crank Generator STEM Kit (Grade 9–10 Focus)', image: '/hand-crank-generator.png', Icon: FiZap, summary: 'Master the fundamental principle of electromagnetism through mechanical energy conversion.', detail: 'A versatile kit designed for school laboratories to illustrate how motors and generators operate on the same basic principle through hands-on experimentation.' },
  { id: 'math-exploration-kit', name: 'Math Exploration Kit (Grade 8–10 Focus)', image: '/homeimg4.png', Icon: FiActivity, summary: 'Master linear equations and trigonometry through physical manipulation of slopes, intercepts, and unit circles.', detail: 'This kit transforms abstract algebraic concepts and trigonometric functions into tangible models, helping students visualize mathematical behavior in real-time.' },
  { id: 'advanced-mechanics', name: 'Coming Soon: Science Kits (Pulley/Hydraulic)', image: '/homeimg4.jpg', Icon: FiCpu, comingSoon: true, summary: "New advanced kits focusing on complex mechanical systems and industrial fluid power applications.", detail: "We're currently perfecting our next series of kits. These will include modular pulley systems for deeper physics exploration and advanced hydraulic models." },
];
