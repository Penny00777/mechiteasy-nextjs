...
const faqData = [
  { question: "What are typical careers that use 3D printing?", answer: (<div className="space-y-5"><p className="leading-7">3D printing is revolutionizing various industries, creating diverse career opportunities:</p><ul className="space-y-4"><li className="flex gap-3"><span className="font-bold text-emerald-600 dark:text-emerald-400 min-w-[130px]">Product Design:</span><span className="text-slate-600 dark:text-slate-400 leading-7">Working on prototypes and consumer products across multiple industries.</span></li><li className="flex gap-3"><span className="font-bold text-emerald-600 dark:text-emerald-400 min-w-[130px]">Engineering:</span><span className="text-slate-600 dark:text-slate-400 leading-7">Mechanical, aerospace, biomedical, and civil engineering for creating critical parts and components.</span></li><li className="flex gap-3"><span className="font-bold text-emerald-600 dark:text-emerald-400 min-w-[130px]">Architecture:</span><span className="text-slate-600 dark:text-slate-400 leading-7">Developing highly detailed architectural models and complex structural designs.</span></li><li className="flex gap-3"><span className="font-bold text-emerald-600 dark:text-emerald-400 min-w-[130px]">Healthcare:</span><span className="text-slate-600 dark:text-slate-400 leading-7">Creating custom prosthetics, dental implants, and patient-specific surgical models.</span></li><li className="flex gap-3"><span className="font-bold text-emerald-600 dark:text-emerald-400 min-w-[130px]">Education:</span><span className="text-slate-600 dark:text-slate-400 leading-7">Teaching 3D printing techniques and managing digital fabrication labs in schools.</span></li></ul></div>) },
  ...
  { question: "What Software Is Used for 3D Design in Your Courses?", answer: (<div className="space-y-6"><p className="leading-7">We utilize industry-standard software adapted for different learning levels:</p><div className="grid gap-5 sm:grid-cols-2 mt-4"><div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800"><h4 className="font-bold text-emerald-600 dark:text-emerald-400 mb-2">Tinkercad</h4><p className="text-xs text-slate-600 dark:text-slate-400 leading-6">Perfect for grades 3-8, offering a beginner-friendly introduction to 3D design.</p></div><div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800"><h4 className="font-bold text-emerald-600 dark:text-emerald-400 mb-2">Fusion 360</h4><p className="text-xs text-slate-600 dark:text-slate-400 leading-6">For grades 9-12, providing advanced capabilities used in professional manufacturing.</p></div><div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800"><h4 className="font-bold text-emerald-600 dark:text-emerald-400 mb-2">Astroprint</h4><p className="text-xs text-slate-600 dark:text-slate-400 leading-6">A cloud platform for seamless file transfer and efficient print management.</p></div><div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800"><h4 className="font-bold text-emerald-600 dark:text-emerald-400 mb-2">Advanced Tools</h4><p className="text-xs text-slate-600 dark:text-slate-400 leading-6">Blender and SketchUp are available depending on course objectives and student level.</p></div></div></div>) },
            ...
            <div className="rounded-3xl border border-slate-200/80 bg-white/70 p-5 shadow-sm backdrop-blur-sm dark:border-slate-700/80 dark:bg-slate-950/70">
              <div className="space-y-3 text-sm text-slate-600 dark:text-slate-300">
                <a href="mailto:aakarantech@gmail.com" className="group flex items-start gap-3 rounded-2xl px-3 py-2 transition hover:-translate-y-0.5 hover:bg-slate-50/80 dark:hover:bg-slate-900/60">
                  ...
                  <div className="space-y-0.5"><p className="text-xs font-semibold text-slate-900 dark:text-slate-50">Email</p><p className="text-xs text-slate-600 dark:text-slate-300">aakarantech@gmail.com</p></div>
                </a>
